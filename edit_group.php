...
<?php
  if(isset($_POST['update'])){
   ...
   if(empty($errors)){
        ...
        $query .= "group_name='{$name}',group_level='{$level}',status='{$status}'";
     ...
     <?php echo display_msg($msg); ?>
      <form method="post" action="edit_group.php?id=<?php echo (int)$e_group['id'];?>" class="clearfix">
        ...
        <div class="form-group">
              ...
              <input type="number"min="1"max="2" class="form-control" name="group-level" value="<?php echo (int)$e_group['group_level']; ?>">
        </div>
        <div class="form-group">
