       ...
       <div class="panel-body"style="overflow-x:auto;">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    <button type="submit" name="update" class="btn btn-info"onclick="return confirm('Are You Sure ?') ">Update</button>
            </div>
        </form>
       </div>
     </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body"style="overflow-x:auto;">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right"onclick="return confirm('Are You Sure ?')">Change</button>
          </div>
        </form>
      </div>
    </div>
